 ...
 *
 * Updated on 4/15/2014 for the Solcoin Gravity Well (includes a fix for the KGW time warp exploit)
 *
...
jint JNI_OnLoad(JavaVM *vm, void *reserved) {
    ...
    jclass cls = (env)->FindClass("hashengineering/difficulty/SolcoinGravityWell/fgw");
